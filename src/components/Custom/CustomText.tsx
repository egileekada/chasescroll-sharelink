...
function CustomText({ type, fontSize = '16px', color = 'grey', text, width = ' 100%' }: IProps) {
    return (
        <>
            {type === 'HEADER' && <Text color={color} fontSize={fontSize} fontFamily={'DM-Bold'} width={width}>{text}</Text>}
